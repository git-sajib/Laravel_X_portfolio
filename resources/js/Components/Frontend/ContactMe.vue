    ...
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
        <div class="container mx-auto" v-motion="{
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">Lorem Fugiat harum. Vitae explicabo labore eligendi, consequatur dolores eos molestias
                    temporibus, maiores, magni suscipit officia necessitatibus facere.</p>
            </div>
            <div class="flex flex-col lg:flex-row lg:gap-x-8">
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            <h4 class="font-body text-xl mb-1"> Make a Call?</h4>
                            <p class="mb-1 text-paragraph">I am here to help you</p>
                            <p class="text-accent font-normal">Call me to +8801714845488</p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div
                        ...
                        <div>
                            ...
                            <p class="mb-1 text-paragraph">Mirpur 12, Dhaka, Bangladesh.</p>
                ...
                <form @submit.prevent="submit" class="space-y-8 w-full max-w-md" action="">
                    <div v-if="showMessage"
                        class="m-2 p-4 bg-light-tail-500 dark:bg-dark-navy-100 text-light-secondary rounded-lg">Thank you
                        for your message. It has been sent.</div>
                    ...
                    <button type="button" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Send Message</button>
                </form>
            </div>
        </div>
    </section>
